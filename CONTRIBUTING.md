...
`pldl` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/pldl
[issue tracker]: https://github.com/<USERNAME>/pldl/issues
